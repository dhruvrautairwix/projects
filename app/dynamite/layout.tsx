...
/**
 * Dynamite page layout that renders the home page as background
 * and the dynamite page content as an overlay on top.
 * 
 * This layout ensures:
 * - Home page stays rendered and visible underneath
 * - Dynamite page renders as fullscreen overlay
 * - No re-rendering of home page when overlay opens
 */
export default function DynamiteLayout({ children }: { children: ReactNode }) {
  return (
    <>
      {/* 
