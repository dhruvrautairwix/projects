...
/**
 * Services page layout that renders the home page as background
 * and the services page content as an overlay on top.
 * 
 * This layout ensures:
 * - Home page stays rendered and visible underneath
 * - Services page renders as fullscreen overlay
