...
/**
 * About page layout that renders the home page as background
 * and the about page content as an overlay on top.
 * 
 * This layout ensures:
 * - Home page stays rendered and visible underneath
 * - About page renders as fullscreen overlay
    ...
    <>
      ...
      */}
      ...
      {/* 
        ...
        - Navbar (z-40) stays visible below overlay
